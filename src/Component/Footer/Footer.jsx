    ...
    <div className="relative mt-16 mr-6">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-12 mt-9 w-full px-8 ml-6">
        ...
        <div className="items-center  md:flex-col md:items-end">
          <h1 className='text-3xl mb-4 text-primary'>Quick Links</h1>
        ...
        <div className="flex flex-col">
          <h1 className='text-3xl mb-4 text-primary'>Contact Info</h1>
          <ul className='space-y-2'>
            <li className=''> Location:<span className='font-normal'>Kigali,</span> <span className='text-primary'> Rwanda</span> </li>
            ...
            <li><a href="#" className=' text-primary'>View Location on GoogleMap</a></li>
          </ul>
        </div>
      </div>
      <div className="min-h-0.5 bg-primary ml-16 mr-16 max-w-full mt-6"></div>
      <div className='flex text-center justify-center mt-6 mb-6 text-[20px]  text-primary'> Copyright © 2024 Aquila Press. All rights reserved. </div>
    </div>
  );
}
